...
\begin{refsection}
      \vspace{2mm}
      \onehalfspacing
C. Pantouvakis et al., {\sl ``First evaluation of the tracking performance of the ARCADIA Fully Depleted MAPS with 120 GeV proton beam''}, \href{https://arxiv.org/html/2606.25655v1}{arXiv:2606.25655v1}. Submitted to NIM A.
    \end{refsection}
...
\begin{refsection}
      \vspace{2mm}
      \onehalfspacing
C. Pantouvakis et al., {\sl ``Impact of front-end parameters of the ARCADIA MD3 on charged particle detection''}, submitted to JINST.
    \end{refsection}
...
\begin{refsection}
      \vspace{2mm}
      \onehalfspacing
M. Rignanese et al., {\sl ``Pixel response characterization of the ARCADIA Fully Depleted MAPS''},
\href{https://doi.org/10.48550/arXiv.2512.15289}{arXiv:2512.15289}. Submitted to JINST.
    \end{refsection}
    ...
    \begin{refsection}
      \vspace{2mm}
      \onehalfspacing
CMS Collaboration, {\sl ``Combination of CMS searches for heavy vector boson resonances at  $\sqrt{s}=13$ TeV''},
\href{https://cds.cern.ch/record/2945027/}{CMS-PAS-B2G-25-003}, \href{https://arxiv.org/abs/2601.12583}{arXiv:2601.12583}. Submitted to JHEP.
    \end{refsection}
    ...
    \begin{refsection}
      \vspace{2mm}
      \onehalfspacing
CMS Collaboration, {\sl ``Vector boson scattering and anomalous quartic couplings in final states with $\ell\nu$qq or $\ell\ell$qq plus jets using proton-proton collisions at $\sqrt{s}=13$ TeV''},
\href{https://cds.cern.ch/record/2926224/files/SMP-22-011-pas.pdf}{CMS-PAS-SMP-22-011}, \href{http://arxiv.org/abs/arXiv:2510.00118}{arXiv:2510.00118}, 
\href{http://dx.doi.org/10.1007/JHEP03(2026)022}{JHEP 03 (2026) 022}.
    \end{refsection}
