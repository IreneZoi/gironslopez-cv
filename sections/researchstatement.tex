...
Particle physics experiments are delivering significant results testing the predictions of the Standard Model (SM) and exploring its extensions. The next years are crucial to make sure we can continue addressing the remaining open questions in the future in an effective way. As a Wilson Fellow I will make sure that we exploit the full potential of the upcoming HL-LHC era and design the next generation of collider experiments. This will be achieved by working on three main areas: 
\begin{itemize}
