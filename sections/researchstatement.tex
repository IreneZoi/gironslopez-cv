...
Vector boson scattering (VBS) and vector boson fusion (VBF) processes are important to investigate the electroweak (EW) sector and are sensitive to new physics at energy scales beyond the collider direct reach through an EFT description of the SM.
...
%FIXME -> continue from here -> describe the collaboration with hayden
...
% FIXME here describe work at the LPC, especially related to EFT. Maybe introduction to my analysis and the one about polariziation
...
\vspace{\baselineskip}
%FIXME - skip or rephrase to introduce detector work
...
\vspace{\baselineskip}
% FIXME -> this part about phD is not relevant here
...
\vspace{\baselineskip}
%FIXME -> maybe rephrase about the LPC
...
\vspace{\baselineskip}
%FIXME -> skip, outdated. Can it be updated?
