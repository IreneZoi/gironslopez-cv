...
As a Wilson Fellow I will ensure that we exploit the full potential of the upcoming High Luminosity LHC era and design the next generation of collider experiments.
...
\begin{itemize}
\item Exploring the electroweak and Higgs sectors measuring polarization in jets and observing Vector Boson Scattering (VBS) in semileptonic final states
\item Delivering the Outer Tracker for the Phase-2 upgrade
